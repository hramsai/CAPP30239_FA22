...
d3.csv('Data/Dates_Data.csv').then(data => {
    let timeParse = d3.timeParse("%m"); // parse time to JS format so code can read it
    ...
    let y = d3.scaleLinear()
        .domain([0,d3.max(data, d => d.Counts)]).nice() // nice helps round axis tick marks
